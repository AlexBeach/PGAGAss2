...
//
//PoolCue::PoolCue(std::string filename/*, glm::vec3 Pos*/)
//{
//	Object = new ObjectLoader(filename);
//	position = glm::vec3(0, 0, -20);
//}
//
//PoolCue::~PoolCue(void)
//{
//
//}
//
//void PoolCue::Update(float deltaTs)
//{
...
//}
//
//void PoolCue::Draw(glm::mat4 viewMatrix, glm::mat4 projMatrix)
//{
